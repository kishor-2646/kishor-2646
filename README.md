...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="./kishor-banner.svg?v=3">
  <source media="(prefers-color-scheme: light)" srcset="./kishor-banner-light.svg?v=3">
  <img src="./kishor-banner.svg?v=3" alt="Kishor Kumar — Software Engineer" width="100%"/>
</picture>
...
<img src="./kishor-views.svg?v=3" alt="Profile views"/>
